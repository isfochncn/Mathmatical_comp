...
root=Path('outputs/问题三费用诊断_20260912');root.mkdir(exist_ok=True)
reports={}
for problem,pointer in [('problem2','out/current_month_output.txt'),('problem3','out/current_problem3_month_output.txt')]:
    folder=Path(Path(pointer).read_text(encoding='utf-8-sig').strip())
